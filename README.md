...
## CastleCSS Framework
The breadcrumbs module is part of the [CastleCSS Meta Package](https://github.com/CastleCSS/castlecss), you need this, the [castlecss-core](https://github.com/CastleCSS/castlecss) or create your own variables files in order to make castlecss-notifications work.

Since castlecss-breadcrumbs v1.0 the castlecss-core is automatically installed into your node_modules too.
...
- Install via [NPM](https://www.npmjs.com/): ```npm install castlecss-breadcrumbs```
...
```npm update castlecss-breadcrumbs```
